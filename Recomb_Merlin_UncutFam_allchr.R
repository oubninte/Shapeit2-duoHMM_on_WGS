...
#In this program: locating recombinations for uncut families 
#                  large merlin intervals based on parent heterozygote markers
...
#cheminMF = paste0(path_rep, "/chr", c(1:8,10:22),"/merlin.flow")
